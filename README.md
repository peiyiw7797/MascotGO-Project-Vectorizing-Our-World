...
| Multimodal Synthetic Data (Issue #2) | `src/universal_embedding/synthetic_data/` | Cross-modal dataset building from simulation outputs | Data orchestration, multimodal alignment, deterministic artifact generation |
